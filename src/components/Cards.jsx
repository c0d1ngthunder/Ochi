...
const Cards = () => {
  return (
    <div data-scroll data-scroll-speed="-.4" className="w-full mt-40 min-h-screen bg-gray-100 sm:items-center flex flex-col md:flex-row gap-4 px-6 sm:px-15">
      <div className="md:w-1/2 w-full md:h-[60vh] h-[46vh] flex items-center justify-center relative bg-[#004D43] rounded-lg">
          <img className="w-1/2" src="./images/logo.svg" alt="" />
